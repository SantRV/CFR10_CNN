...
class CNNModelV3():
    ...
    def plot_loss(self, display: bool = True, save: bool = False):
        ...
        if save:
            filename = f"{self.name}_loss_{datetime.now().strftime('%Y-%m-%d')}.png"
    ...
    def plot_accuracy(self, display: bool = True, save: bool = False):
        ...
        if save:
            filename = f"{self.name}_accuracy_{datetime.now().strftime('%Y-%m-%d')}.png"
    ...
    def plot_prediction_accuracy(self, true_labels, pred_labels, display: bool = True, save: bool = False):
        ...
        if save:
            filename = f"{self.name}_prediction_accuracy_{datetime.now().strftime('%Y-%m-%d')}.png"
